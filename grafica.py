    ...
    for negocio in negocios_seleccionados:
        ...
        axis=1)
            ...
            fig.add_trace(go.Scatter(
                ...
                marker=dict(size=df_filtrado_var["CARTERA CAPITAL TOTAL"] / 100000000, opacity=0.6, color=color, line=dict(width=1, color='DarkSlateGrey')),
    ...
    fig.update_layout(
       title={
        "text": f"Gráfico de dispersión para {negocio} - {plazo_meses} meses" 
                if plazo_meses != "Todos" 
                else f"Gráfico de barras para {negocio} - Todos los periodos",
